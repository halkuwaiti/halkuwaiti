...
- **Secure AI.** How to use language models in security work without letting them make the decisions that matter.
- **Robots and hardware.** Rover autonomy in ROS 2 with BU's Mars Rover club, FPGA and Verilog design in class, and embedded work on the ESP32.
...
| [**CTF write-ups**](https://github.com/halkuwaiti/ctf-writeups) | How I solved the hardest challenges from the ISNR Code Breaker 2026 national final, across binary exploitation, forensics, incident response and web. | Public |
...
Python · C · C++ · Rust · Swift · TypeScript · SQL

Git · Docker · Linux · Wireshark · ROS 2 · React / Next.js

---

### Contact

[LinkedIn](https://linkedin.com/in/hamad-alkuwaiti) · halkuwaiti1@gmail.com
